...
namespace ERP.TimeTableManagement.DataService.Migrations
{
    ...
    [Migration("20240615130213_Initial Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.TimeTableManagement.Core.DaySlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ERP.TimeTableManagement.Core.ERP.TimeTableManagement.Core.Timetable", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ERP.TimeTableManagement.Core.TimeSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ERP.TimeTableManagement.Core.DaySlot", b =>
                {
                    b.HasOne("ERP.TimeTableManagement.Core.ERP.TimeTableManagement.Core.Timetable", "Timetable")
                        .WithMany("DaySlots")
            ...
            modelBuilder.Entity("ERP.TimeTableManagement.Core.TimeSlot", b =>
                {
                    b.HasOne("ERP.TimeTableManagement.Core.DaySlot", "DaySlot")
                        .WithMany("TimeSlots")
